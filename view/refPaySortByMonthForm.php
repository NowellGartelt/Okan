...
<?php }?>
     ...
     <tr>
      ...
      <td>
       <form action="../../Okan/refPaySortByMonthForm.php" method="post">
        <button type="submit" disabled="disabled">月ごと</button>
       </form>
      </td>
     </tr>
    </tbody>
   ...
   <br>
   <form action="../../Okan/refPaySortByMonthResult.php" method="post">
    <table>
     <tbody>
      <tr>
       <td>
...
?>
      ...
      <tr>
       <td>いつからいつまで？：</td>
       <td><input type="month" name="payDateFrom" style="width: 150px" value=<?php echo date("Y-m"); ?>>  ～  
       <input type="month" name="payDateTo" style="width: 150px" value=<?php echo date("Y-m"); ?>></td>
      </tr>
     </tbody>
    </table>
    <br>

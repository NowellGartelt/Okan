...
<?php }?>
  ...
  <br>
  <form action="../controller/refPaySortByMonthResult.php" method="post">
   <table>
    <tbody>
     <tr>
      <td>
     ...
     <tr>
      <td>いつからいつまで？：</td>
      <td><input type="month" name="payDateFrom" value=<?php echo date("Y-m"); ?>>  ～  
      <input type="month" name="payDateTo" value=<?php echo date("Y-m"); ?>></td>
     </tr>
    </tbody>
   </table>
   <br>
